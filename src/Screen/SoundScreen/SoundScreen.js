...
const prevFUN= async()=>{
  ...
  let trackObject1 = await TrackPlayer.getTrack(trackIndex1 == null ? 0 : trackIndex1 - 1)
       ...
       <View style={{
                     ...
                     height: heightPercentageToDP(90)
                      ...
                      <Text style={{
                        ...
                        alignSelf:'center',
                        marginBottom:13,
                      }}>{onPlay !== '' ? onPlay : AllTrack[trackNow]?.title}</Text>
                      <View 
                      opacity={0.7}
                      style={{
                        flexDirection:'row',
                      ...
                      <TouchableOpacity onPress={()=>{setPause(!pause), start()}} >
                        ...
                        source={ pause ? require('@images/pauseMusic.png') : require('@images/playMusic.png')}
                        resizeMode={FastImage.resizeMode.contain}
                      />    
                      </TouchableOpacity>
                      <TouchableOpacity
